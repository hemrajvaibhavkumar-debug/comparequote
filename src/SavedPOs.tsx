                            ...
                            {(() => {
                              ...
                              return (
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <span className={`text-[8px] font-black uppercase px-2 py-0.5 rounded border ${
                                    poType === 'Capital' ? 'bg-purple-50 dark:bg-purple-950/30 text-purple-700 dark:text-purple-400 border-purple-200 dark:border-purple-800' :
                                    poType === 'Consumables' ? 'bg-teal-50 dark:bg-teal-950/30 text-teal-700 dark:text-teal-400 border-teal-200 dark:border-teal-800' :
                                    poType === 'packing item' ? 'bg-amber-50 dark:bg-amber-950/30 text-amber-700 dark:text-amber-400 border-amber-200 dark:border-amber-800' :
                                    poType === 'production item' ? 'bg-rose-50 dark:bg-rose-950/30 text-rose-700 dark:text-rose-400 border-rose-200 dark:border-rose-800' :
