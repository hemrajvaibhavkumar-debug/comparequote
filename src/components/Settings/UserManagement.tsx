...
const ALL_PERMISSIONS = [
  ...
  { key: "APPROVE_PO_L1", label: "PO L1 Approval", description: "First level review and approval for POs" },
  { key: "APPROVE_PO", label: "Final PO Approval", description: "Final approval for POs (Purchase Head)" },
  { key: "APPROVE_INDENT", label: "Indent Approval", description: "Review and approve/reject Indents" },
  { key: "EDIT_APPROVED_PO", label: "Edit Approved POs", description: "Modify PO details even after final approval" },
