                ...
                <div>
                  ...
                  {po.created_by_name && (
                    <div className="mt-3 flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-black text-slate-900 dark:text-slate-100 bg-slate-100 dark:bg-slate-800 px-2.5 py-1 rounded-lg border border-slate-200 dark:border-slate-700 shadow-xs uppercase tracking-tight">{po.created_by_name}</span>
                    </div>
                  )}
                </div>
              </div>
