...
const POPreview: React.FC<POPreviewProps> = ({ po, setPo, settings, actions, isPDF }) => {
  ...
  // --- PDF PAGING LOGIC ---
  // Adjust these based on how many items fit comfortably on a single page
  ...
  const splitItemsIntoPages = () => {
    ...
    // Page 1 - Has limited space due to Letterhead & To Section
  ...
  const FooterContent = () => (
    <div className="w-full flex flex-col justify-between h-full bg-white">
      ...
      {/* Address Footer - Bottom part of every page */}
      {po.version === 'hemraj_ind' && (
    ...
    return (
      <div className="pdf-paged-view flex flex-col gap-10 bg-gray-300 p-10 overflow-visible">
        <style>{`
          ...
          .pdf-body { flex: 1; padding: 5mm 15mm 75mm 15mm; overflow: hidden; }
        `}</style>
            ...
            <div className="pdf-body">
              {pageIdx === 0 && (
                <>
                  ...
                  <div className="flex justify-between items-start mb-6 text-xs text-black">
                    <div className="border border-black p-2 rounded" style={{ boxShadow: '1px 1px 0px black' }}>
              ...
              {pageIdx === itemPages.length - 1 && (
                <div className="mt-4">
                  ...
                  <div className="text-[9px] space-y-1 mb-4 text-black border border-black p-3 rounded font-bold text-left bg-[#fdfdfe]">
